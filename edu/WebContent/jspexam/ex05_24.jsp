...
<body>
	...
	<hr>
	<jsp:useBean id="booker" class="jspbean.BookInfo"/>
	<jsp:setProperty property="bookerName" name="booker" value='<%= request.getParameter("bookerName") %>'/>
	<jsp:setProperty property="bookerColor" name="booker" param= "bookerColor"/>
	<jsp:setProperty property="bookerDateTime" name="booker" />
